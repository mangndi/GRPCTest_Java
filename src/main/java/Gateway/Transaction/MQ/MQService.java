package Gateway.Transaction.MQ;
...
public class MQService  {
    ...
    public void send(OrderStruc ord) throws JMSException {
        try {
    ...
    public MQService(String _userid,String _password,String _url, String _queue)   {
        userid = _userid;
        password = _password;
        url = _url;
        queue = _queue;
